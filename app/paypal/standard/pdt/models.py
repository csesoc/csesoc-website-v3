...
from app.paypal.standard.models import PayPalStandardBase
from app.paypal.standard.conf import POSTBACK_ENDPOINT, SANDBOX_POSTBACK_ENDPOINT
from app.paypal.standard.pdt.signals import pdt_successful, pdt_failed
...
class PayPalPDT(PayPalStandardBase):
    ...
    def _verify_postback(self):
        ...
        from app.paypal.standard.pdt.forms import PayPalPDTForm
        result = False
