...
from app.paypal.pro.forms import PaymentForm, ConfirmForm
from app.paypal.pro.models import PayPalNVP
from app.paypal.pro.helpers import PayPalWPP, TEST
from app.paypal.pro.signals import payment_was_successful, payment_was_flagged
...
class PayPalPro(object):
    ...
    def render_confirm_form(self):
        ...
        contains hidden fields with the token / PayerID from app.paypal.
        """
